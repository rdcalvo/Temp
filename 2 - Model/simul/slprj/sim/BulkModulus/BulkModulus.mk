...
MODEL                = BulkModulus
MODULES              = BulkModulus.c BulkModulus_capi.c BulkModulus_data.c 
MAKEFILE             = BulkModulus.mk
...
MODELLIB                  = BulkModuluslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = BulkModulus_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/BulkModulus \
	-I$(START_DIR) \
	-IC:/Users/PEDROH~1/DOCUME~1/GitHub/MESTRA~1/Matlab/library \
